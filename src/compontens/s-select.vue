<template>
	<view class="s-select">
		<!-- <view class="s-select__action" :class="{
			's-select--border': border
		}" @tap.stop="selectHandler">
			<view class="s-select__action__icon" :class="{
				's-select__action__icon--reverse': value == true
			}">
		...
		<u-popup :border-radius="40" :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
			<view class="s-select">
				<view class="s-select__header" @touchmove.stop.prevent="">
					<view class="s-select__header__title">
						{{title}}
					</view>
					<!-- <view
						class="s-select__header__cancel s-select__header__btn"
					...
					<!-- <view
						class="s-select__header__confirm s-select__header__btn"
				...
				<view class="s-select__body">
					<picker-view @change="columnChange" class="s-select__body__picker-view" :value="defaultSelector" @pickstart="pickstart" @pickend="pickend">
						<picker-view-column v-for="(item, index) in columnData" :key="index">
							<view class="s-select__body__picker-view__item" v-for="(item1, index1) in item" :key="index1">
								<view class="u-line-1">{{ item1[labelName] }}</view>
							</view>
						</picker-view-column>
					</picker-view>
				</view>
				<view class="s-select__footer">
					<view
						class="s-select__footer__cancel s-select__footer__btn"
						:style="{ color: cancelColor }"
						hover-class="u-hover-class"
						:hover-stay-time="150"
						@tap="getResult('cancel')"
					...
					<view
						class="s-select__footer__confirm s-select__footer__btn"
...
<script>
	 ...
	 * @example <s-select v-model="show" :list="list"></s-select>
	 */
export default {
	props: {
		// 列数据
