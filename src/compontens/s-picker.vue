	...
	<u-popup :border-radius="40" :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
		<view class="u-datetime-picker">
			...
			<view class="s-picker-body">
				<picker-view v-if="mode == 'region'" :value="valueArr" @change="change" class="s-picker-view" @pickstart="pickstart" @pickend="pickend">
				...
				<picker-view v-else-if="mode == 'time'" :value="valueArr" @change="change" class="s-picker-view" @pickstart="pickstart" @pickend="pickend">
				...
				<picker-view v-else-if="mode == 'selector'" :value="valueArr" @change="change" class="s-picker-view" @pickstart="pickstart" @pickend="pickend">
				...
				<picker-view v-else-if="mode == 'multiSelector'" :value="valueArr" @change="change" class="s-picker-view" @pickstart="pickstart" @pickend="pickend">
			...
			<view class="s-picker-footer">
				<view
					class="s-picker-footer__cancel s-picker-footer__btn"
				...
				<view
					class="s-picker-footer__confirm s-picker-footer__btn"
...
<script>
// import provinces from '@/../uview-ui/dist/util/province.js';
 ...
 * @example <s-picker v-model="show" mode="time"></s-picker>
 */
export default {
	name: 's-picker',
	props: {
