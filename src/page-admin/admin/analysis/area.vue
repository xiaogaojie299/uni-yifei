...
import { getMyHospitalCascadeList, listSelect,getTransformList,getRegionStatistics } from "@/utils/api.js";
...
export default {
  ...
  methods: {
      showColumnStack(canvasId,chartData){  //堆叠柱形图
    ...
    async getTableList(){
      ...
      let {code,result,msg} =await getRegionStatistics(params);
      try{
        if(code==200){
         /*  
            // 测试数据
            ...
            let params ={
                ...
                series: [{
                    name: "类别一",
                    data: [35, 36, 31, 33, 13, 34,55,12,32]
                }, {
                    name: "类别二",
                    data: [18, 27, 21, 24, 6, 28,1,2,22]
                }, {
                    name: "类别三",
                    data: [18, 27, 21, 24, 6, 28,32,4,77]
                }]
            } 
        */
         let arr = [];  //条形统计图格式转换
