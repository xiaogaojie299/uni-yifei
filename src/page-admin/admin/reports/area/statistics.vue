...
<script>
import { getMyHospitalCascadeList, listSelect,getTransformList,getHospitalReportList,getRegionReportList } from "@/utils/api.js";
...
export default {
  ...
  methods: {
    ...
    async getTableList(){
      ...
      let {code,result,msg} =await getRegionReportList(params);
      try{
        if(code==200){
          console.log(result);
