      ...
      <scroll-view class="scroll-view_H" scroll-x="true">
        <view class="table-box">
          <view class="table-box-item">
            <view class="main-theader">
              <view class="theader">
                <view class="th my-border">
                  <view class="qy-name"> 日期 </view>
                </view>
                <!-- 需要合并单元格的 -->
                <view
                  class="my-border th-col-box"
                  v-for="(item, index) in tableData.legend"
                  :key="index"
                >
                ...
                <view class="th my-border">
                  <view class="qy-name"> 医疗机构人员签字 </view>
                </view>

                <view class="th my-border">
                  <view class="qy-name"> 运输人员签字 </view>
                </view>

                <view class="th my-border">
                  <view class="qy-name"> 交接时间 </view>
                </view>
              </view>
            </view>
